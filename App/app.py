...
def Calculo():
    try:
        ...
        if Porcentaje_Asistencia >=75:
             if Prom >= 40:
                 Estado = 'APROBADO'
                 resultado2 = f'El alumno se encuentra {Estado}'
             else:
                 Estado = 'REPROBADO'
                 resultado2 = f'El alumno se encuentra {Estado} por promedio muy bajo'
        else:
            if Prom < 40:
                Estado = 'REPROBADO'
                resultado2 = (f'El alumno se encuentra {Estado} por promedio muy '
                             f'bajo y por falta de asistencia')
            else:
                Estado='REPROBADO'
                resultado2 =(f'El alumno se encuentra {Estado} por falta de asistencia')
...
def Conteo():
    try:
        ...
        if(nom1 == '' or nom2 == '' or nom3 == ''):
            resultado = ''
            resultado2 = ('Error: Debe ingresar un nombre valido, recuerde '
        ...
        if cantidadNombres == 1:
            ...
            resultado2 = f'Los nombres tiene: {caracterMax} caracteres'
        return render_template('ejercicio2.html', resultado=resultado,
                               resultado2=resultado2)
    except Exception as e:
        resultado = ''
